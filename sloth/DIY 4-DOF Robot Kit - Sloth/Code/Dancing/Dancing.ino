...
const int array_cal[4] = {90,80,95,85}; //Upper Right, Lower Right, Upper Left, Lower Left
...
const int num_dance4 = 20;      //原地 内翻起落，角度递增 In-situ ups and downs, increasing in angle
...
{ 
    {35,0,15,0},    //左脚并向右脚 Left foot and right foot
    {35,30,15,30},   
    {-35,30,15,30},   
    {-20,0,15,0},
    {0,0,0,0},

    {0,-40,0,40},    //内翻转脚 Inner flip foot
    {-30,-40,-20,40},
    {0,-40,0,40},
    {20,-40,30,40},    

    
    {0,-40,0,40},    //原地起落转脚 In place to rise and fall
    {20,-40,-20,40},   
    {20,-20,-20,20},
    {20,0,-20,0},   
    {-20,-10,20,10},
...
{   
    {0,-40,0,-20},        //外八步伐-前进 Outer Eight Steps - Advance
    {25,-40,18,-20},
    {25,0,18,0},
    {0,20,0,40},
    {-18,20,-25,40},
    ...
    {0,-40,0,-20},        //外八步伐-原地踏步 Outer Eight Steps - Stepping In Place
    {25,-40,18,-20},
    {0,0,0,0},
    {0,20,0,40},
    {-18,20,-25,40},
    ...
    {0,-40,0,-20},        //外八步伐-后退 Outer Eight Steps - Backward
    {-25,-40,-18,-20},
    {-25,0,-18,0},
    {0,20,0,40},
    {18,20,25,40},
    ...
    {0,-40,0,-20},        //官网步伐-前进 Official website pace - forward
    {30,-40,30,-20},
    {30,0,30,0},
    {0,20,0,40},
    {-30,20,-30,40},
    ...
    {0,-40,0,-20},        //官网步伐-后退 Official website pace - back
    {-30,-40,-30,-20},
    {-30,0,-30,0},
    {0,20,0,40},
    {30,20,30,40},
